...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		{if $appendCss!=null}<link rel="stylesheet" type="text/css" href="{$appendCss}" />{/if}
	</head>
	<body>
		...
		{/if}
		<br/><br/>
		<form method="post" action="?module=CoreAdminHome&amp;action=optOut{if $language}&amp;language={$language}{/if}{if $appendCss!=null}&amp;appendCss={$appendCss}{/if}">
